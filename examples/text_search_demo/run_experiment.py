...
from tools.demo_runtime_adapters import install_text_demo


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser()
    p.add_argument("--config-file", default="examples/text_search_demo/config.native.yaml")
    ...
    p.add_argument("--unknown-label", default="I DON'T KNOW")
    return p.parse_args()


def main() -> int:
    args = parse_args()
    install_text_demo(main_module, args.unknown_label)
