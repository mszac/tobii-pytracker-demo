...
tobii-pytracker \
  --config_file examples/tobii_image_semantic_demo/config.native.yaml \
  --eyetracker_config_file ../configs/mouse_eyetracker_config.yaml \
  --enable_eyetracker \
  --loop_count 12

python examples/tobii_image_semantic_demo/validate_collection.py \
  --output-root output/tobii_image_semantic_demo \
